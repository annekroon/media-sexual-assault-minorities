...
outlets = ['ad (print)' , 'trouw (print)', 'volkskrant (print)', 'telegraaf (print)', 'nrc (print)']
...
def train_and_save(fromdate,todate,doctype):
    filename = "{}uniekezinnen_{}_{}_ad_trouw".format(PATH,fromdate,todate)
...
if __name__ == "__main__":
    ...
    train_and_save(fromdate = "2014-01-01", todate = "2018-12-31", doctype = outlets)
